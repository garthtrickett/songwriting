...
Status: Phases 1–3 are complete. Phase 4 is active; Phases 5–9 remain planned. Evidence: [Phase 1](docs/PHASE1_VALIDATION.md), [Phase 2](docs/PHASE2_VALIDATION.md), [Phase 3](docs/PHASE3_VALIDATION.md).
...
**Status:** ACTIVE. Detailed specification: [PLAN.md — Phase 4](PLAN.md#phase-4--harmonic-writing-and-independent-voices).
...
**Outcome:** Attach recorded vocal or instrumental ideas to musical structure,
manage takes and binary assets, and export/import complete media bundles.
Improve basic guitar, bass, and drum sounds where it helps writing. Ensure
permission, recording lifecycle, asset durability, playback, and agent controls
remain consistent and recoverable.

## Phase 7 — Extended agent workflows and user customization

**Outcome:** Build on Phase 1's functioning agent loop with editable reusable
prompts, project instructions, songwriting preferences, richer bounded context,
and longer resumable tasks. Improve change review and task visibility; add
shortcuts informed by actual use while preserving primitives. Expand evaluations
for unforeseen tool compositions and interrupted collaborative editing.
